# This module is currently not actively used. Probably this code should be completely rewritten.
...
class SzobaSCH(commands.Cog, name="BME"):
    ...
    # TODO: feleslegesen sok try-except eltávolítása
    # TODO: paraméterek átrendezése csoportokba (lanosch group, -> lanosch.command())
